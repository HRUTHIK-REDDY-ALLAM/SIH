    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="rounded-2xl bg-gradient-to-br from-red-600 to-red-700 text-white p-6 sm:p-8 shadow-xl shadow-red-600/25 animate-rise">
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="text-[11px] font-bold tracking-widest text-red-100">FINANCING DECLINED · FRAUD RISK</div>
            <h1 className="mt-1 text-xl sm:text-2xl font-extrabold leading-snug">Duplicate financing detected on {invoice.code}</h1>
            <p className="mt-2 text-sm text-red-50/90 leading-relaxed">
              The agent found an <span className="font-bold">active lien</span> on this exact invoice ({invoice.irn}) in the
              central receivables registry. The same {inr(invoice.amount)} receivable cannot back two loans.
            </p>
          </div>
        </div>
        ...
        <div className="mt-5 rounded-xl bg-[#12060a]/45 border border-red-400/40 p-4">
          <div className="text-[11px] font-bold tracking-widest text-red-200 mb-3">REGISTRY RECORD — THE EVIDENCE</div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Button variant="ghost" size="lg" className="flex-1" onClick={() => show(`Dispute logged against ${ev.ref} — reference DSP-2026-1043. Expect a response within 2 business days (simulated).`)}>
          Raise a dispute
        </Button>
